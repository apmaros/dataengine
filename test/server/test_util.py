...
def test_format_relative_time_days_when_1_day_ago():
    assert format_relative_time_days(to_datetime('2022-02-01  08:50:00')) == '1 day ago'


@freeze_time("2022-02-02")
def test_format_relative_time_days_when_few_days_ago():
    assert format_relative_time_days(to_datetime('2022-01-28  08:50:00')) == '5 days ago'


@freeze_time("2022-02-01")
def test_format_relative_time_days_when_in_few_days():
    assert format_relative_time_days(to_datetime('2022-02-06  08:50:00')) == 'in 5 days'


@freeze_time("2022-02-01")
def test_format_relative_time_days_when_today():
    assert format_relative_time_days(to_datetime('2022-02-01  08:50:00')) == 'today'
